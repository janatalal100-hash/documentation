...
To process a :ref:`payment <pos/restaurant/bills/payment>` with a :ref:`configured terminal
<pos/terminals/configuration>`, open the POS register, and follow these steps:
